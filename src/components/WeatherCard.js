...
import minTempIcon from "../assets/temperature-min.png";
import maxTempIcon from "../assets/temperature-max.png";
  ...
  return (
    <div className="weather-card">
      ...
      <div className="weather-date">
        <p>Current Time and Date: {formattedTime}  {formattedDate}</p>
      </div>
    </div>
  );
};
